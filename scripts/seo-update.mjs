...
['about.html','About Kabira','About Kabira | Preschool Leadership & Values, Zirakpur','Meet Dr. Rita Rattan, Director-cum-Principal of Kabira The International School in Zirakpur. Explore our approach to early learning, kindness and confidence.','dr-rita-rattan.webp','Kabira The International School; preschool philosophy Zirakpur'],
...
if(file==='about.html')graph.push({'@type':'Person','@id':origin+'/#leadership',name:'Dr. Rita Rattan',jobTitle:'Director-cum-Principal',worksFor:{'@id':origin+'/#school'},image:origin+'/assets/dr-rita-rattan.webp'});
